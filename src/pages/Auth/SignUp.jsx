      ...
      <div className="container h-screen flex items-center justify-center px-20 mx-auto">
        ...
        <div className="w-2/4 h-[75vh] bg-white rounded-r-lg relative px-16 py-4 shadow-lg shadow-cyan-200/20">
          <form onSubmit={handleSignUp}>
            ...
            <input type="text" placeholder="Enter your UserName" className="input-box" value={username} onChange= {(e)=>setUsername(e.target.value)} />
            <input type="text" placeholder="Enter your E-Mail" className="input-box" value={email} onChange= {(e)=>setEmail(e.target.value)} />
